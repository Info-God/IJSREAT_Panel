        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body pt-2 mt-1">
                    <h4 class="pt-3">Add Conference Categories</h4>
                    <form id="formAccountSettings" method="POST" action="{{ route('conference_categories-store') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text"
                                        ...
                                        id="doi" name="name" placeholder="Name" value="{{ old('name') }}" />
